...
export const MoreVertical = (props: IconProps) => (
  <SvgIcon {...props}>
    <circle cx="12" cy="12" r="1.5" fill={props.color || "#0078D4"} />
    <circle cx="12" cy="5" r="1.5" fill={props.color || "#0078D4"} />
    <circle cx="12" cy="19" r="1.5" fill={props.color || "#0078D4"} />
  </SvgIcon>
);
...
export const MoreHorizontal = (props: IconProps) => (
  <SvgIcon {...props}>
    <circle cx="12" cy="12" r="1.5" fill={props.color || "#0078D4"} />
    <circle cx="19" cy="12" r="1.5" fill={props.color || "#0078D4"} />
    <circle cx="5" cy="12" r="1.5" fill={props.color || "#0078D4"} />
  </SvgIcon>
);
